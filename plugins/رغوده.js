...
let handler = async (m, {
  ...
  if (!text) return m.reply("انا بحبك يارغوده انتي بنوته بتجنني وبتاخدي العقل ياروحي انتي",)
  await m.reply("> اﻻنتظار من فضلك يا عيون رغوده......⏳ ")
...
handler.command = /^(رغد|رغودة|رغوده|رغود)$/i
